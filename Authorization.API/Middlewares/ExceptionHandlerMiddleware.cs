...
internal class ExceptionHandlerMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext httpContext, IMessageService messageService)
    {
        ...
        {
            await HandleExceptionAsync(messageService, httpContext, ex, HttpStatusCode.BadRequest, () => Log.Information(ex, ex.Message));
        }
        ...
        {
            await HandleExceptionAsync(messageService, httpContext, ex, HttpStatusCode.Conflict, () => Log.Information(ex, ex.Message));
        }
        catch (Exception ex)
        {
